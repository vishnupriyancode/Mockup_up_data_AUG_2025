...
class ProjectWorkflowDocumentation:
    ...
    def add_usage_examples(self):
        ...
        prob_examples = [
            "Generate all probability types: python generate_probability_outputs.py --all",
            "Generate only positive scenarios: python generate_probability_outputs.py --positive",
            "Generate with multiple records: python generate_probability_outputs.py --all --count 5",
            "Generate split files: python generate_probability_outputs.py --all --count 3 --split"
        ]
    ...
    def add_troubleshooting(self):
        ...
        debug_commands = [
            ...
            "python generate_probability_outputs.py --list - Lists available models",
